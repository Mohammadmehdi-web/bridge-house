        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="index.php">
                    <span class="brand">
                    <img src="./assets/img/logo.png" alt="" width="80px;" height="40px">
                    </span>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <ul class="side-menu metismenu">
                    ...
                    <li class="mt-3">
                        <a href="javascript:;"><i class="sidebar-item-icon"><img width="30" height="30" src="https://img.icons8.com/external-tal-revivo-bold-tal-revivo/24/FFFFFF/external-honorary-mentions-of-great-soldiers-in-a-flag-badges-bold-tal-revivo.png"/></i>
